...
public class HumanChangeMachine implements IChangeMachine {
    ...
    public List<Integer> change(List<Integer> coinsFromPocket, final int costOfItem) {
        ...
        // it's the least efficient way around it. An alternative would be to remove some smaller coins and keep trying
        // different combinations in reverse. Eg, if you're looking for 13 within (5, 5, 2, 2, 2), this by default would
